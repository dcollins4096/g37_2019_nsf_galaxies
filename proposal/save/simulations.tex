...
In addition to probing the questions posed \red{in the objectives}, we will
...
galaxies, their relatively limited ($\Delta x \simeq 100$~pc) spatial  resolution means that they only
...
increase the resolution to $\simeq 1$ pc and follow both molecular cloud
formation as well as more carefully follow star formation and feedback
processes, albeit over substantially less than a Hubble time.
Fortunately, it has been observed that Milky-way sized galaxies have comparable
magnetic field strengths by $z\sim 0.5$, which indicates that the growth time
...
populations (from stellar winds and Type Ia and Type II supernovae) and
from AGN have on magnetic field generation, and also on the possible
...
one spiral, one high $z$ galaxy, one dwarf, and one massive elliptical.  The
...
cosmological simulation; and the two toroidal feedback methods.  The thermal
feedback from supernovae
and thermodynamics will target the formation of molecular clouds.  This
chemistry is already contained in the chemistry solver in \enzo\
\cite[see, e.g.,][]{Tasker11,2014ApJ...783...75M}.  \red{An excellent body of
literature exists on this, which we will keep in contact with}
